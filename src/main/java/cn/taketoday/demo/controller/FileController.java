...
//                         HttpSession session, @Multipart MultipartFile uploadFile) throws IOException //
  public String upload(@Multipart MultipartFile uploadFile) throws IOException {
...
//    public String multiUpload(HttpServletRequest request, HttpSession session, HttpServletResponse response,
  public String multiUpload(@Multipart Set<MultipartFile> files) throws IOException {
...
//    public final void display_void(HttpServletRequest request, HttpServletResponse response,
  ...
  @GET("/void/captcha")
  public final void captcha_void(RequestContext response) throws IOException {
  ...
  @GET("captcha")
  public final BufferedImage captcha(RequestContext response) throws IOException {
  ...
  private final void drawRandomNum(Graphics2D graphics, RequestContext response) {
