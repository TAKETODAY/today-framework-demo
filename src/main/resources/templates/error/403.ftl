...
<head>
    ...
    <style type="text/css">
        * {
        ...
        .bg {
            width: 100%;
            background: url(${CDN}/assets/images/404/back.jpg);
            background-repeat: no-repeat;
            background-position: center
        }

        .img {
            background: url(${CDN}/assets/images/404/head.png) no-repeat;
            position: relative;
            top: 160px;
            width: 178px;
            height: 166px
...
<div class="bg" align="center">
    <div id="box">
        <div class="img"></div>
        <div id="code">403 Access Forbidden !</div>
        <div id="msg" style="font-size: 15px">服务器拒绝处理您的请求！您可能没有访问此操作的权限</div>
    </div>
